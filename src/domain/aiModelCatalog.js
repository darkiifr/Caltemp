...
export const FALLBACK_MODELS = [
  {
    ...
    provider: 'openai',
    lab: 'openai',
    description: 'Modèle OpenRouter rapide et polyvalent.',
  ...
  },
  {
    ...
    provider: 'anthropic',
    lab: 'anthropic',
    description: 'Modèle utile pour rédaction et raisonnement.',
    contextLength: 200000,
    pricing: null,
    logoUrl: `${MODELS_DEV_BASE_URL}/logos/anthropic.svg`,
    labLogoUrl: `${MODELS_DEV_BASE_URL}/logos/labs/anthropic.svg`,
    source: 'fallback',
  },
  {
    ...
    provider: 'google',
    lab: 'google',
    description: 'Modèle rapide disponible via OpenRouter.',
