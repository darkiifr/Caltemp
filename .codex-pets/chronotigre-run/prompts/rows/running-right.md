Create one horizontal animation strip for Codex pet `chronotigre`, state `running-right`.
...
Identity: same pet in every frame: Compact toy tiger desktop helper inspired by Toyger, French calendar app work, React/Tauri desktop development, reminders, precise scheduling, calm pragmatic coding energy; wears a tiny blue-gray developer scarf and carries a small calendar charm; no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: polished sticker mascot, clean outline, readable at 192x208, warm orange tiger with cream muzzle, subtle blue-gray accents, no text.
